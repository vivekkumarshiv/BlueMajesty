# BlueMajesty - A Modern Fullstack E-Commerce Marketplace for Digital Products

Built with the Next.js 14 App Router, tRPC, TypeScript, Payload & Tailwind

![Project Image](https://github.com/joschan21/BlueMajesty/blob/master/public/thumbnail.jpg)
...
try {
    ...
    from: 'BlueMajesty <onboarding@resend.dev>',
    to: [user.email],
...
<Html>
    <Head />
    <Preview>Your BlueMajesty Receipt</Preview>
    ...
    <Container style={container}>
        ...
        Copyright © 2023 BlueMajesty Inc. <br />{' '}
...
<Body style={main}>
    ...
    <Text style={paragraph}>
        Welcome to BlueMajesty, the marketplace for high quality digital
...
export function constructMetadata({
  title = 'BlueMajesty - the marketplace for digital assets',
  description = 'BlueMajesty is an open-source marketplace for high-quality digital goods.',
  image = '/thumbnail.png',
  icons = '/favicon.ico',
  noIndex = false,
}: {
  ...
  return {
    ...
    icons,
    metadataBase: new URL('https://BlueMajesty.up.railway.app'),
    ...(noIndex && {
      robots: {
        index: false,
        follow: false,
